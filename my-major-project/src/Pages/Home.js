    ...
    return (
        <div className='Home-wrapper'>
            ...
            <div className='home-para'>
                <h2>Empower Your Future with <span className='span'>Coding Skills</span></h2>
            ...
            <div className='coding-section'>
                <div className='coding-content'>
                    <h2>Unlock your <span className='span'>coding potential</span> with our online courses.</h2>
            ...
            <div className='coding-section extra'>
                <div className='coding-content extra-content-css' style={{ order: 2 }}>
                    <h2>Start <span className='span'>coding <br />in seconds</span></h2>
                ...
                <div className='coding extra-coding-css' style={{ order: 1, marginLeft: 0 }}>
                    <div className='numbering'>
                        <div>1</div>
                        <div>2</div>
                        <div>3</div>
            ...
            <div className='code-power'>
                <h2>Unlock the <span className='span'>Power of Code</span></h2>
                <p className='code-power-para'>Learn to Build Anything You Can Imagine</p>
                <div className='cards'>
                    <div className='card card1'>
                        <p className='para1'>Learn HTML</p>
                        <p className='para2'>This course covers the basic concepts of HTML including creating and structuring web pages, adding text, links, images, and more.</p>
                    ...
                    <div className='card card2'>
                        ...
                        <p className='para-b'>This course covers the basic concepts of HTML including creating and structuring web pages, adding text, links, images, and more.</p>
            ...
            <div className='white-bg' style={{ background: '#F9F9F9', height: 'auto', width: '100%' }}>
                <div className='demanded_skill'>
                    <div className='demand-content-heading'>
                        <h2>Get the skills you need for a <span className='span'>job that is in demand.</span></h2>
                    </div>
                    ...
                    <div className='lists-content'>
                        <div className='list'>
                            <div className='parent-image'>
                                <img className='l-img' src={Leadership} alt="leadership-image" />
                            </div>
                        ...
                        <div className='list'>
                            <div className='parent-image'>
                                <img className='l-img' src={Responsibility} alt="leadership-image" />
                            </div>
                            <div className='about-img'>
                        ...
                        <div className='list'>
                            <div className='parent-image'>
                                <img className='l-img' src={Flexibility} alt="leadership-image" />
                            </div>
                            <div className='about-img'>
                                <h2>Flexibility</h2>
                        ...
                        <div className='list'>
                            <div className='parent-image'>
                                <img className='l-img' src={Solveproblem} alt="leadership-image" />
                            </div>
                            <div className='about-img'>
                ...
                <div className='learn-language'>
                    <h2>Your swiss knife for<span className='span'> learning any language</span></h2>
                    <center>
            ...
            <div className='Become_Instructor'>
                ...
                <div className='instructor-content'>
                    <h2>Become an <br /><span className='span'>instructor</span></h2>
            ...
            {/* <div className='reviews'>
                <OwlCarousel className="owl-theme" items={4} autoplay={true} loop={true} nav={false} margin={50} dots={false} autoplayTimeout={3000} autoplayHoverPause={true}>
                    ...
                    <div className='item' >
                        <div className=' review-card'>
                            ...
                            <div className='row-2'>
                                <p>Coordination of activities improved tremendously with Learn codings.</p>
                            </div>
                            <div className='row-3'>
                                <p>4.5</p>
                                <div>
