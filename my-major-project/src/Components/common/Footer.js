                    ...
                    <div className='subfooter-left-side'>
                        <div className='col-1'>
                            ...
                            <div className='company-links'>
                                {["About", "Carrers", "Affiliates"].map((ele, i) => {
                                    return (
                                        <div key={i}>
                                            <Link className='Link' to={ele.toLowerCase()}>{ele}</Link>
                                        </div>
                                    )
                                })}
                            </div>
                        ...
                        <div className='col-2'>
                            <div className='resourses'>
                                <h2 className='col-2-heading'>
                                    Resources
                                </h2>
                                <div className='resourses-links'>
                                    {Resources.map((ele, i) => {
                                        return <div key={i}>
                                            <Link className='Link' link to={ele.split(" ").join("-").toLowerCase()}>{ele}</Link>
                                        </div>
                                    })}
                                </div>
                            </div>
                            ...
                            <div className='support'>
                                ...
                                <div className='support-link'>
                                    <Link className='Link' linkto={"/help-center"}>Help Center</Link>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='col-3'>
                            <div className='Plans'>
                                ...
                                <div className='plan-links'>
                                    {Plans.map((ele, i) => {
                                        return <div key={i}>
                                            <Link className='Link' linkto={ele.split(" ").join("-").toLowerCase()}>{ele}</Link>
                                        </div>
                                    })}
                                </div>
                            </div>
                                    ...
                                    <div className='right-side' key={i}>
                                        ...
                                        <div className='ele-links'>
                                            {ele.links.map((link, index) => {
                                                return (
                                                    <div key={index}>
                                                        <Link className='Link' linkto={link.link}>{link.title}</Link>
                                                    </div>
                                                )
                                            })}
                                        </div>
                        ...
                        {BottomFooter.map((ele, i) => {
                            return (
                                <div key={i} className="bottom-footer">
                                    <Link className='Link' linkto={ele.split("").join("-").toLowerCase()}>
                                        {ele}
                                    </Link>
                                </div>
                            )
